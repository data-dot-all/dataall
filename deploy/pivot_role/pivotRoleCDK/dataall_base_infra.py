...
class dataAllBaseInfra(Stack):
    def __init__(self, scope: Construct, construct_id: str, config, **kwargs) -> None:
        ...
        self.create_dataall_role(
            name='dataallPivotRole',
            principal_id=config.DATAALL_ACCOUNT,
            external_id=config.EXTERNAL_ID,
            env_resource_prefix=config.RESOURCE_PREFIX,
        )
    ...
    def create_dataall_role(self, name: str, principal_id: str, external_id: str, env_resource_prefix: str) -> iam.Role:
        """
