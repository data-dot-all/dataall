...
def get_console_url():
    ...
    try:
        url = ssm.get_parameter(Name=f'/dataall/{ENVNAME}/frontend/custom_domain_name')[
            'Parameter'
        ]['Value']
...
def get_canary_onboarded_environment():
    try:
        ssm = boto3.client('ssm')
        env_account = ssm.get_parameter(
            Name=f'/dataall/{ENVNAME}/canary/environment_account'
        )['Parameter']['Value']

        env_region = ssm.get_parameter(
            Name=f'/dataall/{ENVNAME}/canary/environment_region'
        )['Parameter']['Value']
...
def signout(browser):
    browser.find_element_by_xpath(
        '/html/body/div[1]/div/header/div/div[5]/button'
    ).click()
...
async def main():
    ...
    def login_cognito():
        ...
        browser.implicitly_wait(TIMEOUT)
        browser.find_element_by_xpath(
            '//div[contains(@class, "visible-lg")]//*[@id="signInFormUsername"]'
        ).send_keys(creds['username'])
        browser.find_element_by_xpath(
            '//div[contains(@class, "visible-lg")]//*[@id="signInFormPassword"]'
    ...
    def create_organization():
        browser.implicitly_wait(TIMEOUT)
        browser.find_element_by_xpath(
            '/html/body/div[1]/div/div[2]/div/div/div/div/div[1]/div[2]/div/a'
        ).click()
        browser.implicitly_wait(TIMEOUT)
        browser.find_element_by_xpath(
        ...
        browser.find_element_by_xpath(
            '//*[@id="mui-component-select-SamlGroupName"]'
        ).click()
        browser.implicitly_wait(5)
        browser.find_element_by_xpath(
            '//*[@id="menu-SamlGroupName"]/div[3]/ul/li[1]'
        ).click()
        browser.find_element_by_xpath(
    ...
    def link_environment():
        ...
        browser.find_element_by_xpath(
            '//*[@id="root"]/div/div[2]/div/div/div/div/div[3]/div/div[2]/div[2]/a'
        ).click()
        browser.find_element_by_xpath(
    ...
    def delete_environment():
        browser.implicitly_wait(TIMEOUT)
        browser.find_element_by_xpath(
            '/html/body/div[1]/div/div[2]/div/div/div/div/div[1]/div[2]/div/button'
        ).click()
        browser.find_element_by_xpath(
            '/html/body/div[3]/div[3]/div/div/div[2]/div/label/span[1]/span[1]'
        ).click()
        browser.find_element_by_xpath(
            '/html/body/div[3]/div[3]/div/div/div[3]/div[1]/div/div/input'
        ).send_keys('permanently delete')
        browser.find_element_by_xpath(
            '/html/body/div[3]/div[3]/div/div/div[3]/div[2]/button'
        ).click()
    ...
    def delete_organization():
        ...
        browser.find_element_by_xpath(
            '/html/body/div[3]/div[3]/div/div/div[3]/div/div/input'
        ).send_keys('permanently archive')
        browser.find_element_by_xpath(
            '/html/body/div[3]/div[3]/div/div/div[4]/button'
        ).click()
