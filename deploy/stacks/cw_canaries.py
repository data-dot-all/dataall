    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.bucket = s3.Bucket(
            ...
            server_access_logs_bucket=s3.Bucket.from_bucket_name(self, f"AccessLogsBucket", logs_bucket.bucket_name),
        ...
        role_inline_policy = iam.Policy(
            ...
            statements=[
                ...
                iam.PolicyStatement(
                    ...
                    resources=[f"arn:aws:secretsmanager:{self.region}:{self.account}:secret:*{resource_prefix}*"],
                ),
                iam.PolicyStatement(
                    actions=[
                        "s3:ListAllMyBuckets",
