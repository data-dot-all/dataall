    ...
    def __init__(
        ...
        **kwargs,
        ...
        if custom_domain and custom_domain["hosted_zone_name"]:
            ...
            frontend_alias_configuration = cloudfront.ViewerCertificate.from_acm_certificate(
        ...
        cloudfront_distribution = cloudfront.CloudFrontWebDistribution(
            ...
            origin_configs=[
                cloudfront.SourceConfiguration(
                    ...
                    behaviors=[cloudfront.Behavior(is_default_behavior=True, default_ttl=Duration.hours(1))],
                )
            ],
            ...
            logging_config=cloudfront.LoggingConfiguration(bucket=logging_bucket, prefix="cloudfront-logs/frontend"),
        )
        ...
        if userguide_alternate_domain:
            userguide_alias_configuration = cloudfront.ViewerCertificate.from_acm_certificate(
        ...
        if userguide_alternate_domain:
            userguide_record = route53.ARecord(
                ...
                zone=hosted_zone,
                target=route53.RecordTarget.from_alias(route53_targets.CloudFrontTarget(userguide_docs_distribution)),
            )
                ...
                cloudfront.SourceConfiguration(
                    ...
                    behaviors=[
                        cloudfront.Behavior(
                            ...
                            compress=True,
                            forwarded_values=cloudfront.CfnDistribution.ForwardedValuesProperty(query_string=True),
