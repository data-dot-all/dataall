        ...
        front_stage_actions = (
            pipelines.CodeBuildStep(
                ...
                commands=[
                    ...
                    f'aws codeartifact login --tool pip --repository {self.codeartifact.npm_repo.attr_name} --domain {self.codeartifact.domain.attr_name} --domain-owner {self.codeartifact.domain.attr_owner}',
