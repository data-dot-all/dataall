...
def create_react_env_file(
    ...
    domain = ssm.get_parameter(Name=f"/dataall/{envname}/cognito/domain")["Parameter"]["Value"]
...
if __name__ == "__main__":
    ...
    create_react_env_file(region, envname, resource_prefix, internet_facing, custom_domain, enable_cw_rum)
