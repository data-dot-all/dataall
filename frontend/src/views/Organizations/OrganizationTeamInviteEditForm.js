...
const OrganizationTeamInviteEditForm = (props) => {
  ...
  const [permissions] = useState([{ name: 'LINK_ENVIRONMENTS', description: 'Link environments to this organization' }, { name: 'INVITE_ENVIRONMENT_GROUP', description: 'Invite teams to this organization' }]);
