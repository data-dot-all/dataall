        ...
        <Grid item md={10} xs={6}>
          ...
          >
            <Typography color="textSecondary" variant="body1">
              {`LF Tag Key access: ${share.lfTagKey} 
                LF Tag Value access: ${share.lfTagValue}
          ...
          {(share.status === 'PendingApproval' ||
            ...
            <Box sx={{ ml: 7 }}>
              <LoadingButton
                ...
                sx={{ mt: 6, mb: 1, mr: 1 }}
                onClick={() => navigate(`/console/shares/${share.lftagShareUri}`)}
                type="button"
                variant="outlined"
              >
                Update
...
ShareOutboxListLFTagItem.propTypes = {
  share: PropTypes.object.isRequired,
  reload: PropTypes.func.isRequired
};
export default ShareOutboxListLFTagItem;
