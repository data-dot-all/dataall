...
import updateShareRequestReason from '../../api/ShareObject/updateShareRequestReason';


const UpdateRequestReason = (props) => {
...
export default UpdateRequestReason;
