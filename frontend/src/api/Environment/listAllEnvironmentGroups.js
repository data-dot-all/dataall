...
const listAllEnvironmentGroups = ({ filter, environmentUri }) => ({
  variables: {
    environmentUri,
    filter
  },
  query: gql`
            query listAllEnvironmentGroups($filter:GroupFilter,$environmentUri:String!){
...
export default listAllEnvironmentGroups;
