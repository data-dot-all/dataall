...
export const GenerateMetadataModal = (props) => {
  ...
  const [openView, setOpenView] = useState('GENERATE_FORM');
            ...
            <Grid item lg={2} xl={2} md={2} sm={2} xs={2}>
              <FormControl sx={{ minWidth: 200, mb: 1 }}>
                ...
                >
                  ...
                  <MenuItem value={'TablesAndFolders'}>
                    Tables and Folders
                  </MenuItem>
                </Select>
              </FormControl>
              ...
              {targetType === 'TablesAndFolders' && (
                <Typography //TODO: better info messages
                  ...
                  sx={{ ml: 1 }}
                >
                  Data.all will use table column names and table descriptions
                  and folder S3 prefix names to generate Tables and Folders
                  label, description, tags and/or topics using Amazon Bedrock.
                </Typography>
              )}
            </Grid>
            <Grid item lg={6} xl={6} md={6} sm={6} xs={6}>
