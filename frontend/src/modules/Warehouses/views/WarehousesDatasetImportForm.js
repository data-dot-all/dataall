...
//TODO: implement
//import { importWarehouseDataset } from '../services';
import { Topics, ConfidentialityList } from '../../constants';
import config from '../../../generated/config.json';
import { isFeatureEnabled } from 'utils';

const WarehousesDatasetImportForm = (props) => {
  ...
  async function submit(values, setStatus, setSubmitting, setErrors) {
    ...
    //       variant: 'success'
    //     });
    //     navigate(`/console/datasets/${response.data.importWarehouseDataset.datasetUri}`);
    //   } else {
    //     dispatch({ type: SET_ERROR, error: response.errors[0].message });
    //   }
    // } catch (err) {
...
export default WarehousesDatasetImportForm;
