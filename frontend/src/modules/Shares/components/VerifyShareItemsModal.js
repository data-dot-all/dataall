...
import { getShareObject, verifyItemsShareObject } from '../services';
import { generateShareItemLabel } from 'utils';

export const VerifyShareItemsModal = (props) => {
    ...
    <Dialog maxWidth="md" fullWidth onClose={onClose} open={open} {...other}>
      <Box sx={{ p: 3 }}>
        <Typography
          ...
          variant="h4"
        >
          Verify share item health from share object {share.dataset.datasetName}
        </Typography>
        <Typography align="center" color="textSecondary" variant="subtitle2">
          {
            'After selecting the items that you want to verify, click on Verify Selected Items'
          }
        </Typography>
        <Divider />
        <Box sx={{ p: 3 }} />
...
VerifyShareItemsModal.propTypes = {
