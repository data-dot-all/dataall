...
const MLStudioList = Loadable(lazy(() => import('./views/MLStudio/NotebookList')));
const MLStudioView = Loadable(lazy(() => import('./views/MLStudio/NotebookView')));
const MLStudioCreateForm = Loadable(lazy(() => import('./views/MLStudio/NotebookCreateForm')));
