...
def test_prefix_delta():
    ...
    assert (
        prefix == "s3://insite-data-lake-core-alpha-eu-west-1/forecast/ship_plan/insite_version=0.1/insite_region_id=2"
    )
    prefix = (
        "arn:aws:s3:::insite-data-lake-core-alpha-eu-west-1/forecast/ship_plan/insite_version=0.1/insite_region_id=2"
    )
