...
def patch_dataset_methods(module_mocker):
    ...
    module_mocker.patch(
        'dataall.modules.datasets.services.datasets_enums.ConfidentialityClassification.validate_confidentiality_level',
        return_value=True,
    )

    confidentiality_classification_mocker = MagicMock()
    module_mocker.patch(
        'dataall.modules.datasets.services.datasets_enums.ConfidentialityClassification',
