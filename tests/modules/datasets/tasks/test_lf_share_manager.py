...
def test_check_catalog_account_exists_and_update_processor_with_catalog_exists(
        db, dataset1, share, table1, table2, source_environment, target_environment,
                            target_environment_group, mock_glue_client,
        mocker
):
    ...
    mock_glue_client().get_source_catalog.return_value = {'account_id' : '12129101212', 'database_name' : 'catalog_db', 'region' : 'us-east-1'}
...
def test_check_catalog_account_exists_and_update_processor_with_catalog_exists_and_tag_doesnt_exists(
    ...
    # Override the mocks to check catalog account details
    mock_glue_client().get_source_catalog.return_value = {'account_id': '12129101212', 'database_name': 'catalog_db',
                                                          'region': 'us-east-1'}
