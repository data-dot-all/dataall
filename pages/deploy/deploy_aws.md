    ...
    "DeploymentEnvironments": [
      {
        ...
        "pivot_role_as_part_of_environment": "boolean_CREATE_PIVOT_ROLE_AS_PART_OF_ENVIRONMENT_STACK|DEFAULT=false"
      }
    ]
  }
}
...
| pivot_role_as_part_of_environment      | Optional              | If set to **true**, data.all creates the pivot IAM role as part of the environment stack. If false, a CloudFormation template is provided in the UI and AWS account admins need to deploy this stack as pre-requisite to link a data.all environment (default: false) |
