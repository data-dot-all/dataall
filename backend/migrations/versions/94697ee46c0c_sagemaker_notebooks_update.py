...
def upgrade():
    ...
    op.add_column(
        'sagemaker_notebook', sa.Column('SubnetId', sa.String(), nullable=True)
    )
    op.add_column(
        'sagemaker_notebook', sa.Column('VolumeSizeInGB', sa.Integer(), nullable=True)
    )
    op.add_column(
        'sagemaker_notebook', sa.Column('InstanceType', sa.String(), nullable=True)
    )
