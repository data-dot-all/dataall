...
def upgrade():
    ...
    op.create_foreign_key('omics_run_workflowUri_fkey', 'omics_run', 'omics_workflow', ['workflowUri'], ['workflowUri'], ondelete='cascade')
    op.create_foreign_key('omics_run_environmentUri_fkey', 'omics_run', 'environment', ['environmentUri'], ['environmentUri'], ondelete='cascade')
