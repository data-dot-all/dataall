...
def downgrade():
    ...
    op.create_table('worksheet',
                    ...
                    sa.Column('chartConfig', postgresql.JSON(astext_type=sa.Text()), autoincrement=False,
                              nullable=True),
    ...
    op.create_table('worksheet_query_result',
                    ...
                    sa.Column('status', sa.VARCHAR(), autoincrement=False, nullable=False),
                    sa.Column('queryType', postgresql.ENUM('chart', 'data', name='querytype'), autoincrement=False,
                              nullable=False),
