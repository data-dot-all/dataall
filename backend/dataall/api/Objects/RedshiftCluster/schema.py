...
RedshiftCluster = gql.ObjectType(
    ...
    fields=[
        ...
        gql.Field(name="userRoleInEnvironment", type=RedshiftClusterRole.toGraphQLEnum()),
        gql.Field(
            "organization",
            type=gql.Ref("Organization"),
            resolver=get_cluster_organization,
        ),
        gql.Field("environment", type=gql.Ref("Environment"), resolver=get_cluster_environment),
