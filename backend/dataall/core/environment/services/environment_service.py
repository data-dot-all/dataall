...
class EnvironmentService:
    ...
    @ResourcePolicyService.has_resource_permission(core_permissions.LINK_ENVIRONMENT)
    ...
    @staticmethod
    @TenantPolicyService.has_tenant_permission(core_permissions.MANAGE_ENVIRONMENTS)
    @ResourcePolicyService.has_resource_permission(core_permissions.UPDATE_ENVIRONMENT)
    ...
    @staticmethod
    @TenantPolicyService.has_tenant_permission(core_permissions.MANAGE_ENVIRONMENTS)
    @ResourcePolicyService.has_resource_permission(core_permissions.INVITE_ENVIRONMENT_GROUP)
    ...
    def validate_permissions(session, uri, g_permissions, group):
        ...
        """
        if core_permissions.INVITE_ENVIRONMENT_GROUP in g_permissions:
            g_permissions.append(core_permissions.REMOVE_ENVIRONMENT_GROUP)

        g_permissions.extend(core_permissions.ENVIRONMENT_INVITED_DEFAULT)
        g_permissions = list(set(g_permissions))

        if g_permissions not in core_permissions.ENVIRONMENT_INVITED:
    ...
    @staticmethod
    @TenantPolicyService.has_tenant_permission(core_permissions.MANAGE_ENVIRONMENTS)
    @ResourcePolicyService.has_resource_permission(core_permissions.REMOVE_ENVIRONMENT_GROUP)
    ...
    @staticmethod
    @TenantPolicyService.has_tenant_permission(core_permissions.MANAGE_ENVIRONMENTS)
    @ResourcePolicyService.has_resource_permission(core_permissions.UPDATE_ENVIRONMENT_GROUP)
    ...
    @staticmethod
    @ResourcePolicyService.has_resource_permission(core_permissions.LIST_ENVIRONMENT_GROUP_PERMISSIONS)
    ...
    def list_group_invitation_permissions(session, username, groups, uri, data=None, check_perm=None):
        ...
        for p in core_permissions.ENVIRONMENT_INVITATION_REQUEST:
    ...
    @staticmethod
    @TenantPolicyService.has_tenant_permission(core_permissions.MANAGE_ENVIRONMENTS)
    @ResourcePolicyService.has_resource_permission(core_permissions.ADD_ENVIRONMENT_CONSUMPTION_ROLES)
    def add_consumption_role(session, uri, data=None) -> (Environment, EnvironmentGroup):
        ...
        ResourcePolicyService.attach_resource_policy(
            ...
            permissions=core_permissions.CONSUMPTION_ROLE_ALL,
    ...
    @staticmethod
    @TenantPolicyService.has_tenant_permission(core_permissions.MANAGE_ENVIRONMENTS)
    @ResourcePolicyService.has_resource_permission(core_permissions.REMOVE_ENVIRONMENT_CONSUMPTION_ROLE)
    ...
    def update_consumption_role(session, uri, env_uri, input):
        ...
        if consumption_role:
            ResourcePolicyService.update_resource_policy(
                ...
                new_permissions=core_permissions.CONSUMPTION_ROLE_ALL,
            )
    ...
    @staticmethod
    @ResourcePolicyService.has_resource_permission(core_permissions.LIST_ENVIRONMENT_GROUPS)
    ...
    def list_environment_groups(session, uri) -> [str]:
        return [
            g.groupUri
            for g in EnvironmentService.query_user_environment_groups(session, get_context().groups, uri, {}).all()
        ]
    ...
    @staticmethod
    @ResourcePolicyService.has_resource_permission(core_permissions.LIST_ENVIRONMENT_CONSUMPTION_ROLES)
    ...
    @staticmethod
    @ResourcePolicyService.has_resource_permission(core_permissions.LIST_ENVIRONMENT_NETWORKS)
    ...
    @staticmethod
    @ResourcePolicyService.has_resource_permission(core_permissions.GET_ENVIRONMENT)
    ...
    @staticmethod
    @ResourcePolicyService.has_resource_permission(core_permissions.DELETE_ENVIRONMENT)
