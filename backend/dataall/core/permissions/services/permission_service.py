...
from dataall.core.permissions.services.permissions_constants.resources_permissions import RESOURCES_ALL_WITH_DESC
from dataall.core.permissions.services.permissions_constants.tenant_permissions import TENANT_ALL_WITH_DESC
