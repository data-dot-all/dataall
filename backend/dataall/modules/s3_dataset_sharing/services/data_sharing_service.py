...
from dataall.modules.s3_dataset_sharing.services.share_processors.lakeformation_process_share import (
    ProcessLakeFormationShare,
)
from dataall.modules.s3_dataset_sharing.services.share_processors.s3_access_point_process_share import (
    ProcessS3AccessPointShare,
)
from dataall.modules.s3_dataset_sharing.services.share_processors.s3_bucket_process_share import ProcessS3BucketShare
...
from dataall.modules.datasets_base.db.dataset_base_models import DatasetLock
...
class DataSharingService:
    ...
    @classmethod
    def verify_share(
        cls, engine: Engine, share_uri: str, status=None, healthStatus=ShareItemHealthStatus.PendingVerify.value
    ):
        """
