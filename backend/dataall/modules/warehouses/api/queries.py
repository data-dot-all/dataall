...
from dataall.modules.warehouses.api.input_types import WarehouseFilter
from dataall.modules.warehouses.api.resolvers import (
    list_warehouse_connections,
    list_warehouse_consumers
)

listWarehouseConnections = gql.QueryField(
    name='listWarehouseConnections',
    args=[gql.Argument('filter', WarehouseFilter)],
