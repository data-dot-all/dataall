...
class RedshiftDatasetsSharesApiModuleInterface(ModuleInterface):
    ...
    def __init__(self):
        ...
        ShareProcessorManager.register_processor(
            ShareProcessorDefinition(ShareableType.RedshiftTable, None, RedshiftTable, RedshiftTable.rsTableUri)
        )
...
class RedshiftDatasetsSharesECSShareModuleInterface(ModuleInterface):
    ...
    def __init__(self):
        ...
        from dataall.modules.redshift_datasets.db.redshift_models import RedshiftTable  # TODO
