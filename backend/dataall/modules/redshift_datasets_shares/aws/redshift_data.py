...
class RedshiftShareDataClient:
    ...
    def create_external_schema(self, database: str, schema: str):
        ...
        sql_statement = f"CREATE EXTERNAL SCHEMA {RedshiftShareDataClient.identifier(f'{database}_{schema}')} FROM DATABASE {RedshiftShareDataClient.identifier(database)} SCHEMA {RedshiftShareDataClient.identifier(schema)};"
        self._execute_statement(sql=sql_statement)
