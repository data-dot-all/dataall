...
TENANT_ALL_WITH_DESC[MANAGE_SGMSTUDIO_USERS] = 'Manage ML studio users'

RESOURCES_ALL.append(SGMSTUDIO_USER_ALL)
RESOURCES_ALL_WITH_DESC[CREATE_SGMSTUDIO_USER] = 'Create ML Studio users on this environment'
