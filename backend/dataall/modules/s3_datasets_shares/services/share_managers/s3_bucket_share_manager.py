...
class S3BucketShareManager:
    ...
    def check_role_bucket_policy(self) -> None:
        ...
        if not bucket_policy:
            ...
            for target_sid in perm_to_sids(self.share.permissions, SidType.BucketPolicy):
    ...
    def check_dataset_bucket_key_policy(self) -> None:
        ...
        for target_sid in perm_to_sids(self.share.permissions, SidType.KmsBucketPolicy):
