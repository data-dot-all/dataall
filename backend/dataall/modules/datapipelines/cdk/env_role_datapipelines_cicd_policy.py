...
class AwsCICD(ServicePolicy):
    ...
    """
<<<<<<<< HEAD:backend/dataall/cdkproxy/stacks/policies/aws_cicd.py
    def get_statements(self):
========
    def get_statements(self, group_permissions, **kwargs):
        if CREATE_PIPELINE not in group_permissions:
            return []
>>>>>>>> upstream/modularization-main:backend/dataall/modules/datapipelines/cdk/env_role_datapipelines_cicd_policy.py
        statements = [
            iam.PolicyStatement(
