...
from dataall.modules.datasets_base.services.datasets_base_enums import DatasetType
...
class DatasetProfilingRun(Resource, Base):
    __tablename__ = 's3_dataset_profiling_run'
...
class DatasetStorageLocation(Resource, Base):
    __tablename__ = 's3_dataset_storage_location'
    datasetUri = Column(String, nullable=False)
...
class DatasetTable(Resource, Base):
    __tablename__ = 's3_dataset_table'
    datasetUri = Column(String, nullable=False)
...
class DatasetBucket(Resource, Base):
    __tablename__ = 's3_dataset_bucket'
