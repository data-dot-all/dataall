...
class S3DatasetRepository(EnvironmentResource):
    """DAO layer for S3 Datasets"""
    ...
    @staticmethod
    def get_dataset_by_uri(session, dataset_uri) -> S3Dataset: ##TODO: this function is used inside the module
