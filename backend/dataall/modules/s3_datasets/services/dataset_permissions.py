...
DATASET_TABLE_DATA_FILTERS_ALL = [CREATE_TABLE_DATA_FILTER, DELETE_TABLE_DATA_FILTER, LIST_TABLE_DATA_FILTERS]
...
for perm in chain(DATASET_ALL, DATASET_TABLE_READ, DATASET_TABLE_DATA_FILTERS_ALL, DATASET_FOLDER_READ):
