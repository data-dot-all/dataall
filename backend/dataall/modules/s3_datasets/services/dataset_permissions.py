...
CREATE_DATASET_TABLE_QUALITY_RULE = 'CREATE_DATASET_TABLE_QUALITY_RULE'

DATASET_TABLE_READ = [GET_DATASET_TABLE, PREVIEW_DATASET_TABLE, CREATE_DATASET_TABLE_QUALITY_RULE]
