<<<<<<<< HEAD:backend/dataall/modules/datasets/api/storage_location/schema.py
from dataall.api import gql
========
from dataall.base.api import gql
>>>>>>>> modularization-main:backend/dataall/modules/datasets/api/storage_location/types.py
