...
def test_map_props(mocker):
    ...
    stack = ATestStack()
    lambdafx_props = LambdaFxPropsMapper.map_function_props(stack, "myfx", lambdafx["config"])
...
def test_map_function_props_1():
    ...
    assert lambdafx_props["role"].role_arn == "arn:aws:iam::0123456789012:role/dhdatasciencedevoqtnpj"
    assert lambdafx_props["layers"] == []
