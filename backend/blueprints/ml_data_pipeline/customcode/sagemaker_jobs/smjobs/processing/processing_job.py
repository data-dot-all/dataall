...
if __name__ == "__main__":
    ...
    output_bucket = args.output_bucket if args.output_bucket else os.environ.get("output_bucket")
    output_prefix = args.output_prefix if args.output_prefix else os.environ.get("output_prefix")
    ...
    df_all["EmbarkedLabelEncoded"] = label_encoder.transform(df_all["Embarked"].astype(str))

    # Save the label encoder
    create_serialized_label_encoder(label_encoder, output_bucket, output_prefix, label_encoder_key)
    ...
    create_output(validation, output_bucket, output_prefix, output_separator, validation_data)
