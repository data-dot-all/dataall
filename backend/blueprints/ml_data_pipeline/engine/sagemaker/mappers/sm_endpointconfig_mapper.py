...
class SageMakerEndpointConfigPropsMapper:
    @classmethod
    def map_props(cls, stack, endpoint_config_name, config_props: dict, model_name_from_input) -> dict:
        endpoint_config = dict(
            ...
            production_variants=cls.map_product_variants(config_props, model_name_from_input),
    ...
    @classmethod
    def map_product_variants(cls, config_props, model_name_from_input) -> [ProductionVariant]:
        production_variants = []
        ...
        production_variants.append(
            ProductionVariant(
                ...
                instance_type=aws_ec2.InstanceType(instance_type_identifier=instance_type),
